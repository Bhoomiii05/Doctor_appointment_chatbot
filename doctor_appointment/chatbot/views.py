...
def get_available_times(request):
    ...
    url = 'https://api.calendly.com/scheduling/availability?user={CALENDLY_USER}&event_type={CALENDLY_EVENT_TYPE}'
    try:
...
def send_email_view(request):
    if request.method == 'POST':
        ...
        if translated_text:  # If translation is successful
            ...
            receiver_email = "bhoomiii.512@gmail.com"  # Replace with actual doctor's email
